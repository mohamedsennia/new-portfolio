...
export class ExperiencesService{
   private experiences: Experience[] = [
        new Experience(1, "Bachelor's degree","Software and Information Systems Engineering",'./assets/images/usthb.png',`
        ...
        new Experience(2, "Master's degree","Visual computing",'./assets/images/usthb.png',`
        ...
        new Experience(3, "Assistant engineer level 2","Algerian supreme court",'./assets/images/cs.png',`
            <ul>
        ...
        new Experience(4, "Full stack developper","Yaldinine",'./assets/images/yalidine.png',`
            <ul>
        ...
        new Experience(5, "Real-Time Messaging Application","","./assets/images/yapper.png",`
            <ul>
        ...
        new Experience(6, "Price Tracker Platform","","./assets/images/tracker.png",`
            <ul>
        ...
        new Experience(7, "Multiplayer Blackjack Game","","./assets/images/blackjack.png",`
            <ul>
